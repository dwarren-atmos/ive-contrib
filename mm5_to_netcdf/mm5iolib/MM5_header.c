...
/*                                                                            */
/* RCS id string                                                              */
/*   "$Id: MM5_header.c,v 1.6 2001/10/30 08:44:59 graziano Exp $";
                                                                              */
/*                                                                            */
/* -------------------------------------------------------------------------- */
...
void get_reftime(t_mm5_file *file, time_t *tt)
{
  ...
  else
  {
    ...
    {
      mtm.tm_year = file->header.v3.BHI[v3_ibin(5, pgi)] - 1900;
      mtm.tm_mon = file->header.v3.BHI[v3_ibin(6, pgi)] - 1;
      mtm.tm_mday = file->header.v3.BHI[v3_ibin(7, pgi)];
      mtm.tm_hour = file->header.v3.BHI[v3_ibin(8, pgi)];
      mtm.tm_min = file->header.v3.BHI[v3_ibin(9, pgi)];
      mtm.tm_sec = file->header.v3.BHI[v3_ibin(10, pgi)];
      mtm.tm_isdst = 0;
    }
  }
...
float get_grid_distance(t_mm5_file *file)
{
  ...
  else return(file->header.v3.BHR[v3_rbin(9, 1)]);
}
...
float get_coarse_grid_d(t_mm5_file *file)
{
  ...
  else return(file->header.v3.BHR[v3_rbin(1, 1)]);
}
...
/* RETURN      : none                                                         */
/* -------------------------------------------------------------------------- */
void MM5_print_headinfo(t_mm5_file *file)
{
  fprintf(stdout, "####################################################\n");
